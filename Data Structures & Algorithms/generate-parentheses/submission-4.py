class Solution:
    def generateParenthesis(self, n: int) -> List[str]:
        ...
        result = []
        # curr = ""
        curr = [] # v2: use it as run-in array as string append costs O(n)
        ...
        def dfs(curr, o, c):
            ...
            if o == n and c == n:
                # result.append(curr) 
                # no need to copy string since this is NOT array so not passed by reference but passed by value

                result.append("".join(curr)) 
                return
            
            # below is unncessary thanks to line 167's base case check 
